...
export const learningResources: ResourceItem[] = [
    ...
    // --- CERTIFICATIONS ---
    { name: 'Google Cloud AI', url: 'https://cloud.google.com/learn/certification/machine-learning-engineer', desc: 'Professional ML Engineer certification.', category: 'Certifications', type: 'certification', logoText: 'GCP', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/cloud.google.com' },
    { name: 'AWS AI/ML', url: 'https://aws.amazon.com/certification/certified-machine-learning-specialty/', desc: 'AWS Certified Machine Learning Specialty.', category: 'Certifications', type: 'certification', logoText: 'AWS', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/aws.amazon.com' },
    { name: 'Microsoft Azure AI', url: 'https://learn.microsoft.com/en-us/certifications/azure-ai-engineer/', desc: 'Azure AI Engineer Associate certification.', category: 'Certifications', type: 'certification', logoText: 'AZ', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/microsoft.com' },
    { name: 'TensorFlow Developer', url: 'https://www.tensorflow.org/certificate', desc: 'TensorFlow Developer Certificate.', category: 'Certifications', type: 'certification', logoText: 'TF', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/tensorflow.org' },
    { name: 'DeepLearning.AI', url: 'https://www.deeplearning.ai/courses/', desc: 'AI and Deep Learning specializations.', category: 'Certifications', type: 'certification', logoText: 'DL', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/deeplearning.ai' },
    { name: 'IBM AI Engineering', url: 'https://www.coursera.org/professional-certificates/ai-engineer', desc: 'IBM AI Engineering Professional Certificate.', category: 'Certifications', type: 'certification', logoText: 'IBM', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/ibm.com' },
    { name: 'Databricks Lakehouse', url: 'https://www.databricks.com/learn/certification', desc: 'Databricks Certified Data Engineer.', category: 'Certifications', type: 'certification', logoText: 'DB', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/databricks.com' },
    { name: 'NVIDIA Deep Learning', url: 'https://www.nvidia.com/en-us/training/', desc: 'NVIDIA Deep Learning Institute certifications.', category: 'Certifications', type: 'certification', logoText: 'NV', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/nvidia.com' },
    { name: 'Stanford ML', url: 'https://www.coursera.org/specializations/machine-learning-introduction', desc: 'Machine Learning Specialization by Andrew Ng.', category: 'Certifications', type: 'certification', logoText: 'S', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/stanford.edu' },
    { name: 'MIT Professional', url: 'https://professional.mit.edu/programs/certificate-programs/professional-certificate-program-machine-learning-artificial', desc: 'MIT Professional Certificate in ML & AI.', category: 'Certifications', type: 'certification', logoText: 'MIT', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/mit.edu' },
    { name: 'Coursera ML', url: 'https://www.coursera.org/professional-certificates/google-advanced-data-analytics', desc: 'Google Advanced Data Analytics Certificate.', category: 'Certifications', type: 'certification', logoText: 'G', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/coursera.org' },
    { name: 'Udacity Nanodegree', url: 'https://www.udacity.com/course/ai-artificial-intelligence-nanodegree--nd898', desc: 'AI Programming with Python Nanodegree.', category: 'Certifications', type: 'certification', logoText: 'U', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/udacity.com' },
    { name: 'edX MicroMasters', url: 'https://www.edx.org/micromasters/columbiax-artificial-intelligence', desc: 'Columbia AI MicroMasters Program.', category: 'Certifications', type: 'certification', logoText: 'eX', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/edx.org' },
    { name: 'DataCamp Certification', url: 'https://www.datacamp.com/certification', desc: 'Data Scientist and ML certifications.', category: 'Certifications', type: 'certification', logoText: 'DC', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/datacamp.com' },
    { name: 'Hugging Face', url: 'https://huggingface.co/learn/nlp-course/chapter1/1', desc: 'NLP Course and certifications.', category: 'Certifications', type: 'certification', logoText: 'HF', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/huggingface.co' },
    { name: 'Fast.ai Certification', url: 'https://www.fast.ai/', desc: 'Practical Deep Learning certificates.', category: 'Certifications', type: 'certification', logoText: 'F', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/fast.ai' },
    { name: 'Kaggle Learn', url: 'https://www.kaggle.com/learn', desc: 'Free micro-courses with certificates.', category: 'Certifications', type: 'certification', logoText: 'K', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/kaggle.com' },
    { name: 'LinkedIn Learning', url: 'https://www.linkedin.com/learning/topics/artificial-intelligence-ai', desc: 'AI and ML courses with certificates.', category: 'Certifications', type: 'certification', logoText: 'LI', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/linkedin.com' },
    { name: 'Oracle AI', url: 'https://education.oracle.com/oracle-cloud-infrastructure-2024-ai-foundations-associate/pexam_1Z0-1122-24', desc: 'Oracle Cloud AI Foundations certification.', category: 'Certifications', type: 'certification', logoText: 'O', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/oracle.com' },
    { name: 'Salesforce AI', url: 'https://trailhead.salesforce.com/credentials/aiassociate', desc: 'Salesforce AI Associate certification.', category: 'Certifications', type: 'certification', logoText: 'SF', subscribers: 'N/A', logoUrl: 'https://logo.clearbit.com/salesforce.com' },
];
