...
export const learningResources: ResourceItem[] = [
    ...
    { name: 'Ollama', url: 'https://github.com/ollama/ollama', desc: 'Get up and running with Llama 2, Mistral, and other large language models.', category: 'Large Language Models', type: 'github', logoText: 'OL', subscribers: '5k Stars', logoUrl: 'https://unavatar.io/github/ollama' },
